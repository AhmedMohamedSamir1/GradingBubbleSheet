...
import static com.example.gp2021.ui.instructor.Util.sortLeft2Right;
import static com.example.gp2021.ui.instructor.Util.sortTopLeft2BottomRight;
import static com.example.gp2021.ui.instructor.Util.sout;
import static com.example.gp2021.ui.instructor.Util.write2File;
...
public class Scanner {
    ...
    public  HashMap<Integer,String> scan() throws Exception {
        ...
        for(int index = 0; index < answers.size(); index++){
            ...
            if(optionIndex==null)
            {
                Ans.put(index+1,"EMPTY/INVALID");
            }
            else
            {
                Ans.put(index+1,options[optionIndex]);
            }
